    ...
    <div>
        <form method="POST" action="">
            <div class="jumbotron" style="margin-left:55px; margin-right: 55px; margin-top: 25px;">
                <h1 class="display-4" style="text-align:center">Councellor Signup</h1>
...
<?php 
    ...
    $db = mysqli_select_db($connection, "councellor");
    ...
    if(isset($_POST['submit'])){
        ...
        if($query_run){
            ...
            header("location:councellor_login.php");
            exit;
        }else {
            echo '<script>alert("Something Went Wrong")</script>';
            header("location:councellor_signup.php");
            exit;
        }
    }
?>