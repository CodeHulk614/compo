...
<?php 
    ...
    if(isset($_POST['submit'])){
        ...
        // if($mc === ""){
        //     if($team === "team a"){
        //         $query = "INSERT INTO cta (`id`,`fname`, `mname`, `lname`, `email`, `number`, `gender`, `cv`, `ps`, `ssce`, `dp, `orl`, `arl`, `bh`, `trans`, `priority`, `team`)
        //     VALUES ('$id','$fname','$mname', '$lname','$email', '$number','$gender','$cv','$ps','$ssce','$dp','$orl', '$arl', '$bh', '$trans', '$priority', '$team')";
        ...
        //      }
        //     }elseif($team === "team b"){
        //         $query = "INSERT INTO ctb (`id`,`fname`, `mname`, `lname`, `email`, `number`, `gender`, `cv`, `ps`, `ssce`, `dp`, `orl`, `arl`, `bh`, `trans`, `priority`, `team`)
        //     VALUES ('$id','$fname','$mname', '$lname','$email', '$number','$gender','$cv','$ps','$ssce','$dp', '$orl', '$arl', '$bh', '$trans', '$priority', '$team')";
        //     $query_run = mysqli_query($connection, $query);
        ...
        //     }
        //     }elseif($team === "team c"){
        //         $query = "INSERT INTO ctc (`id`,`fname`, `mname`, `lname`, `email`, `number`, `gender`, `cv`, `ps`, `ssce`, `dp`, `orl`, `arl`, `bh`, `trans`, `priority`, `team`)
        //     VALUES ('$id','$fname','$mname', '$lname','$email', '$number','$gender','$cv','$ps','$ssce','$dp', '$orl', '$arl', '$bh', '$trans', '$priority', '$team')";
        //     $query_run = mysqli_query($connection, $query);
        ...
        //      }
        //     }elseif($team === "team d"){
        //         $query = "INSERT INTO ctd (`id`,`fname`, `mname`, `lname`, `email`, `number`, `gender`, `cv`, `ps`, `ssce`, `dp`, `orl`, `arl`, `bh`, `trans`, `priority`, `team`)
        //     VALUES ('$id','$fname','$mname', '$lname','$email', '$number','$gender','$cv','$ps','$ssce','$dp','$orl', '$arl', '$bh', '$trans', '$priority', '$team')";
        //     $query_run = mysqli_query($connection, $query);
        ...
        //      }
        //     }elseif($team === "team e"){
        //         $query = "INSERT INTO cte (`id`,`fname`, `mname`, `lname`, `email`, `number`, `gender`, `cv`, `ps`, `ssce`, `dp`, `orl`, `arl`, `bh`, `trans`, `priority`, `team`)
        //     VALUES ('$id','$fname','$mname', '$lname','$email', '$number','$gender','$cv','$ps','$ssce','$dp','$orl', '$arl', '$bh', '$trans', '$priority', '$team')";
        //     $query_run = mysqli_query($connection, $query);
        ...
        //      }
        //     }elseif($team === "team f"){
        //         $query = "INSERT INTO ctf (`id`,`fname`, `mname`, `lname`, `email`, `number`, `gender`, `cv`, `ps`, `ssce`, `dp`, `orl`, `arl`, `bh`, `trans`, `priority`, `team`)
        //     VALUES ('$id','$fname','$mname', '$lname','$email', '$number','$gender','$cv','$ps','$ssce','$dp','$orl', '$arl', '$bh', '$trans', '$priority', '$team')";
        //     $query_run = mysqli_query($connection, $query);
        ...
        //      }
        //     }elseif($team === "team g"){
        //         $query = "INSERT INTO ctg (`id`,`fname`, `mname`, `lname`, `email`, `number`, `gender`, `cv`, `ps`, `ssce`, `dp`, `orl`, `arl`, `bh`, `trans`, `priority`, `team`)
        //     VALUES ('$id','$fname','$mname', '$lname','$email', '$number','$gender','$cv','$ps','$ssce','$dp','$orl', '$arl', '$bh', '$trans', '$priority', '$team')";
        //     $query_run = mysqli_query($connection, $query);
        ...
        //      }
        //     }elseif($team === "team h"){
        //         $query = "INSERT INTO cth (`id`,`fname`, `mname`, `lname`, `email`, `number`, `gender`, `cv`, `ps`, `ssce`, `dp`, `orl`, `arl`, `bh`, `trans`, `priority`, `team`)
        //     VALUES ('$id','$fname','$mname', '$lname','$email', '$number','$gender','$cv','$ps','$ssce','$dp','$orl', '$arl', '$bh', '$trans', '$priority', '$team')";
        //     $query_run = mysqli_query($connection, $query);
        ...
        //      }
        //     }elseif($team === "team i"){
        //         $query = "INSERT INTO cti (`id`,`fname`, `mname`, `lname`, `email`, `number`, `gender`, `cv`, `ps`, `ssce`, `dp`, `orl`, `arl`, `bh`, `trans`, `priority`, `team`)
        //     VALUES ('$id','$fname','$mname', '$lname','$email', '$number','$gender','$cv','$ps','$ssce','$dp','$orl', '$arl', '$bh', '$trans', '$priority', '$team')";
        //     $query_run = mysqli_query($connection, $query);
        ...
        // }else{
            if($team === "team a"){
                $query = "INSERT INTO cta (`id`,`fname`, `mname`, `lname`, `email`, `number`, `gender`, `cv`, `ps`, `ssce`, `dp`, `mc`, `orl`, `arl`, `bh`, `trans`,`year`, `month`, `team`)
            VALUES ('$id','$fname','$mname', '$lname','$email', '$number','$gender','$cv','$ps','$ssce','$dp','$mc','$orl', '$arl', '$bh', '$trans', '$year', '$month','$team')";
            $query_run = mysqli_query($connection, $query);
            ...
            if($query_run){
                ...
                $query = "INSERT INTO ctb (`id`,`fname`, `mname`, `lname`, `email`, `number`, `gender`, `cv`, `ps`, `ssce`, `dp`, `mc`, `orl`, `arl`, `bh`, `trans`, `year`, `month`, `team`)
            VALUES ('$id','$fname','$mname', '$lname','$email', '$number','$gender','$cv','$ps','$ssce','$dp','$mc','$orl', '$arl', '$bh', '$trans', '$year', '$month', '$team')";
            $query_run = mysqli_query($connection, $query);
            ...
            if($query_run){
               echo "<script> window.location.href='success.html' </script>";
                ...
                $query = "INSERT INTO ctc (`id`,`fname`, `mname`, `lname`, `email`, `number`, `gender`, `cv`, `ps`, `ssce`, `dp`, `mc`, `orl`, `arl`, `bh`, `trans`, `year`, `month`, `team`)
            VALUES ('$id','$fname','$mname', '$lname','$email', '$number','$gender','$cv','$ps','$ssce','$dp','$mc','$orl', '$arl', '$bh', '$trans', '$year', '$month', '$team')";
            $query_run = mysqli_query($connection, $query);
            ...
            if($query_run){
                ...
                $query = "INSERT INTO ctd (`id`,`fname`, `mname`, `lname`, `email`, `number`, `gender`, `cv`, `ps`, `ssce`, `dp`, `mc`, `orl`, `arl`, `bh`, `trans`, `year`, `month`, `team`)
            VALUES ('$id','$fname','$mname', '$lname','$email', '$number','$gender','$cv','$ps','$ssce','$dp','$mc','$orl', '$arl', '$bh', '$trans', '$year', '$month', '$team')";
            $query_run = mysqli_query($connection, $query);
            ...
            if($query_run){
                ...
                $query = "INSERT INTO cte (`id`,`fname`, `mname`, `lname`, `email`, `number`, `gender`, `cv`, `ps`, `ssce`, `dp`, `mc`, `orl`, `arl`, `bh`, `trans`, `year`, `month`, `team`)
            VALUES ('$id','$fname','$mname', '$lname','$email', '$number','$gender','$cv','$ps','$ssce','$dp','$mc','$orl', '$arl', '$bh', '$trans', '$year', '$month', '$team')";
            $query_run = mysqli_query($connection, $query);
            ...
            if($query_run){
                ...
                $query = "INSERT INTO ctf (`id`,`fname`, `mname`, `lname`, `email`, `number`, `gender`, `cv`, `ps`, `ssce`, `dp`, `mc`, `orl`, `arl`, `bh`, `trans`, `year`, `month`, `team`)
            VALUES ('$id','$fname','$mname', '$lname','$email', '$number','$gender','$cv','$ps','$ssce','$dp','$mc','$orl', '$arl', '$bh', '$trans', '$year', '$month', '$team')";
            $query_run = mysqli_query($connection, $query);
            ...
            if($query_run){
                ...
                $query = "INSERT INTO ctg (`id`,`fname`, `mname`, `lname`, `email`, `number`, `gender`, `cv`, `ps`, `ssce`, `dp`, `mc`, `orl`, `arl`, `bh`, `trans`, `year`, `month`, `team`)
            VALUES ('$id','$fname','$mname', '$lname','$email', '$number','$gender','$cv','$ps','$ssce','$dp','$mc','$orl', '$arl', '$bh', '$trans', '$year', '$month', '$team')";
            $query_run = mysqli_query($connection, $query);
            ...
            if($query_run){
                ...
                $query = "INSERT INTO cth (`id`,`fname`, `mname`, `lname`, `email`, `number`, `gender`, `cv`, `ps`, `ssce`, `dp`, `mc`, `orl`, `arl`, `bh`, `trans`, `year`, `month`, `team`)
            VALUES ('$id','$fname','$mname', '$lname','$email', '$number','$gender','$cv','$ps','$ssce','$dp','$mc','$orl', '$arl', '$bh', '$trans', '$year', '$month', '$team')";
            $query_run = mysqli_query($connection, $query);
            ...
            if($query_run){
                ...
                $query = "INSERT INTO cti (`id`,`fname`, `mname`, `lname`, `email`, `number`, `gender`, `cv`, `ps`, `ssce`, `dp`, `mc`, `orl`, `arl`, `bh`, `trans`, `year`, `month`, `team`)
            VALUES ('$id','$fname','$mname', '$lname','$email', '$number','$gender','$cv','$ps','$ssce','$dp','$mc','$orl', '$arl', '$bh', '$trans', '$year', '$month', '$team')";
            $query_run = mysqli_query($connection, $query);
