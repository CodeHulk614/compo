...
<body onload="changeValue()">
    ...
    <h1>BSCE Student Registration</h1>
    ...
    <form action="" method="POST" enctype="multipart/form-data">
        ...
        <label for="bh">OND/A Levels/HND <span style="font-size: x-small;"> (PDF Format Only)</span> <span style="font-size: small; color: red;"> *</span></label>
        <input type="file" id="bh" name="bh" required>
